...
<h2 class="text-center"> Thank you for Ordering'! We will update your order via email.</h2>
...
<div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                              <a href="index.php"><input type="submit" class="btn btn-success btn-block" value="Home" required="" /></a>  
                            </div>
        </body>
