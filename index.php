...
<div id="container">
	...
	<div id="carousel">
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				...
				<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner8.jpg" class="carousel"></div>
			</div>
	...
	<div id="content">
		<div id="product" style="position:relative; margin-top:30%;">
			<center><h2><legend>Online Clothing.co</legend></h2></center>
			<br />
