...
<body>
	<div id="header">
		...
		<label>Online Clothing Store</label>
	...
	<br />
		...
		<div id="content">
			<legend><h3>Privacy Policy</h3></legend>
				<p>The Online Clothing Store Incorporated respect the privacy of the visitors
					to the Online Clothing Store.com website and the local websites connected with it, and take great care to protect your
			...
			<hr>
				<h4>Protection of visitors information</h4>
					<p>In order to protect the information you provide to us by visiting our website we have implemented various
						...
						risk that third parties may intercept and use that information. While Online Clothing Store strives to protect its user's
			...
			<hr>
				<h4>Online policy</h4>
					<p>The Privacy Policy does not extend to anything that is inherent in the operation of the internet, and
						therefore beyond kids wear control, and is not to be applied in any manner contrary to applicable law or
...
<div>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Online Clothing Store Inc. 2017 Brought To You by <a href="https://code-projects.org/">Code-Projects</a></p>
		</div>

			<div id="foot">
				<h4>Links</h4>
					<ul>
						<a href="http://www.facebook.com/OnlineClothingStore"><li>Facebook</li></a>
						<a href="http://www.twitter.com/OnlineClothingStore"><li>Twitter</li></a>
						<a href="http://www.pinterest.com/OnlineClothingStore"><li>Pinterest</li></a>
						<a href="http://www.tumblr.com/OnlinesClothingStore"><li>Tumblr</li></a>
					</ul>
			</div>
	</div>
</body>
